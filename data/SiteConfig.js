const config = {
	siteTitle: 'AdiJha.com', // Site title.
	siteTitleShort: 'AdiJha Blog', // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation.
	siteTitleAlt: 'AdiJha Blog', // Alternative site title for SEO.
	...
	userEmail: 'mail@adijha.com', // Email used for RSS feed's author segment
	userTwitter: 'adijha07', // Optionally renders "Follow Me" in the Bio segment.
	userGitHub: 'adijha', // Optionally renders "Follow Me" in the Bio segment.
